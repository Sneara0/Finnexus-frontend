...
export default function TransactionsPage() {
  ...
  // GET /api/v1/transactions/summary - সামারি
  ...
  // GET /api/v1/transactions - সব ট্রানজেকশন
  const fetchTransactions = useCallback(async () => {
    ...
    try {
      ...
      if (sortBy === "date") filters.sortBy = "date";
      if (sortBy === "amount") filters.sortBy = "amount";
  ...
  // DELETE /api/v1/transactions/:id - ট্রানজেকশন ডিলিট
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="text-right">
                      ...
                      <div className="flex gap-2 mt-1 justify-end opacity-0 group-hover:opacity-100 transition">
                        ...
                        <button onClick={() => handleDelete(transaction.id)} className="p-1 text-slate-400 hover:text-red-400 transition">
